...
import { type Child as HastscriptChild, h, s } from "hastscript";
			...
			visit(tree, "element", (node: Element) => {
				...
				if (isDirectory) {
					...
					icon.children.unshift(
						h("span", { class: "sr-only" }, directoryLabel),
					);
				}
				...
				const treeEntryChildren: HastscriptChild[] = [
